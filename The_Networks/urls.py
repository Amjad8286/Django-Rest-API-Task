"""The_network2 URL Configuration
...
urlpatterns = [
    ...
    path('gettoken/', jwt_views.TokenObtainPairView.as_view(), name ='get_token'),
    path('verifiy/',jwt_views.TokenVerifyView.as_view(), name ='token_verify'),
